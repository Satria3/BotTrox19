...
kp = LINETCR.LINE()
kp.login(token="EqCQV4Xbt7fHlhYgUBud.nI0+pkrzsIaJT928xZbUBq.AzE6+ebi0x+XnVazhYcPu9R9Fi+PKs9CKCKa4nAEA3Q=")
kp.loginResult()

kq = LINETCR.LINE()
kq.login(token="Eqixl8C941Gv5hRQQ1Oa.VSkC4kWnVqaJsixjMKNE/G.LZcRDlgubJxkwt6wssjfeXlOWiPDOhW6mUGoHlZK9mE=")
kq.loginResult()

kr = LINETCR.LINE()
kr.login(token="Eq8a1kGdhzncFNclSwE8.aWOMtct5v8ZYoiURB63+6a.uXYoZThrYy/BE6ZtIYDK/P8fmAI7+yWy2PPsJ25a4Os=")
kr.loginResult()

ks = LINETCR.LINE()
ks.login(token="EqinhCtJYhf2qsldL9Q8.jyCu5B2qelpygXkvspNkYa.clyuM1pLjwH/fW2K5peDhb5lO85xQ/Sy41aQMC4eUfc=")
ks.loginResult()

kt = LINETCR.LINE()
kt.login(token="EqDmLkbl9sozzKSc0Ceb.PpTPPNkiz0/ZXpxswLg6EW.nFxDdd/hTkAH+KyR1JfYmbgoFnLGxwNt31pQ+Ju7TN4=")
kt.loginResult()

print "SUCSES BOTTROX19 Bot"
reload(sys)
...
wait = {
    ...
    'timeline':True,
    'autoAdd':False,
    'message':"Thanks for add Me http://line.me/ti/p/up3NLjmK17",
    "lang":"JP",
    "comment":"AutoLike by http://line.me/ti/p/up3NLjmK17",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#==================================================
            ...
            elif msg.text in ["Bot cancel","Botcancel"]:
                if msg.toType == 2:
				...
				cl.sendMessage(msg)
				cl.sendText(msg.to,"My Creator 👉BOTTROX TEAM ")
            elif "Id" == msg.text:
                key = msg.to
...
#=================================================
                    ...
                    if msg.to in wait2['readPoint']:
                        ...
                        cl.sendText(msg.to, "Ketik Cctv dulu dudul Baru bilang Read Point.")
